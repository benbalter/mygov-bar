...
//inject MyGov Bar
$_response_body = str_ireplace( '</body>', '<iframe id="mygov-bar" src="//presidential-innovation-fellows.github.com/mygov-bar/mygov-bar.html" style="bottom:0;left:0;position:fixed;height:50px;width:100%;border:none;">Alt Text</iframe></body>', $_response_body );
echo $_response_body;
?>